...
class ProductTemplate(models.Model):
    ...
    uos_coeff = fields.Float('Unit of Measure -> UOS Coeff', digits_compute= dp.get_precision('Product UoM'),
...
class SaleOrder(models.Model):
    ...
    product_uos_qty = fields.Float(string='Quantity', digits_compute= dp.get_precision('Product UoM'),
